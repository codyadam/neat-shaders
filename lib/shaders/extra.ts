...
const section = (name: string, params: ParamDef[]): ParamDef[] => params.map((p) => ({ ...p, section: name }));
...
function pixelSortParams(includeAxis: boolean): ParamDef[] {
  ...
  return [
    ...
    },
    {
      ...
      section: "Sort",
      default: true,
      description: "Bright (or high-key) pixels first.",
    },
    {
      type: "float",
      key: "strength",
...
export const EXTRA_SHADERS: ShaderDefinition[] = [
  ...
  },
  {
    ...
    params: [
      ...
      ...section("Look", [
        ...
        { type: "color", key: "ink", label: "Ink", default: [0.95, 0.95, 0.92], enabledWhen: { key: "color_mode", equals: 0 } },
        ...
        {
          type: "float",
          key: "original_opacity",
          label: "Original opacity",
          min: 0,
          max: 1,
          step: 0.01,
          default: 0,
          description: "Show the source image behind the glyphs. 0 is solid background.",
        },
        {
          type: "float",
          key: "edge",
  ...
  {
    id: "brand-overlay",
    name: "Head on display",
    group: "Stylized",
    description:
      "Head on display: survey-drawing overlay with contrast-aware marks, a distance mesh with sized markers, a shrinking circle chain, and colour-mapped mosaic squares on hashed anchors (WeatherNext by default).",
    usesAtlas: true,
    atlasStyle: "label",
    ...
    params: [
      ...section("Zones", [
        ...
        },
        {
          ...
          enabledWhen: { key: "zone_count", notEquals: 0 },
        },
        {
          type: "float",
          key: "zone_size",
      ...
      ...section("Chain", [
        ...
        { type: "bool", key: "intersections", label: "Intersections", default: true, enabledWhen: "chain_enabled" },
        {
          type: "float",
          key: "marker_size",
          label: "Marker size",
          ...
          enabledWhen: ["chain_enabled", "intersections"],
        },
      ]),
      ...section("Detection", [
        {
        ...
        },
        {
          ...
          step: 1,
          default: 95,
          description: "Actual cap on marks drawn. Each mark is a random pick biased toward high-score spots (not an even grid).",
        },
        {
          type: "float",
          key: "min_distance",
          ...
          step: 1,
          default: 40,
          description: "Minimum gap between mark centres, in pixels. 0 allows clusters on the best spots.",
        },
        {
          type: "int",
          key: "size_seed",
      ...
      ...section("Mesh", [
        ...
        },
        {
          ...
          enabledWhen: { key: "max_distance", notEquals: 0 },
        },
        {
          type: "float",
          key: "mesh_marker",
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        step: 0.01,
        default: 1,
        description: "Size of the bright center. Higher is a wider focus.",
      },
    ],
  },
  {
